...
from django.urls.converters import BitYadConverter

from ticketing import views

register_converter(BitYadConverter, 'movie_id')

app_name = 'ticketing'
urlpatterns = [
    path('movie/list/', views.movie_list, name='movie_list'),
    path('movie/details/<movie_id:movie_id>/', views.movie_details, name='movie_details'),
