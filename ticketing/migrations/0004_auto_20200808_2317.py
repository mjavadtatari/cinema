# Generated by Django 3.0.7 on 2020-08-08 18:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='movie',
            name='poster',
            field=models.ImageField(default='temp', upload_to='movie_poster/', verbose_name='پوستر'),
        ...
        migrations.AlterField(
            model_name='cinema',
            name='cinema_code',
            field=models.IntegerField(primary_key=True, serialize=False, verbose_name='کد اختصاصی'),
        ),
        migrations.AlterField(
            model_name='cinema',
            name='city',
        ...
        migrations.AlterField(
            model_name='showtime',
            name='free_seats',
            field=models.IntegerField(verbose_name='صندلی های آزاد'),
        ),
        migrations.AlterField(
            model_name='showtime',
            name='movie',
        ...
        migrations.AlterField(
            model_name='showtime',
            name='status',
            field=models.IntegerField(choices=[(1, 'فروش آغاز نشده است'), (2, 'در حال فروش بلیت'), (3, 'بلیت ها تمام شد'), (4, 'فروش بلیت بسته شد'), (5, 'فیلم پخش شد'), (6, 'سانس لغو شد')], verbose_name='وضعیت'),
        ),
    ]
